...
from app.api.endpoints import camera, statistics, websocket, auth, sessions, labels, esp_audio
...
router.include_router(esp_audio.router, prefix="/esp", tags=["esp_audio"])
